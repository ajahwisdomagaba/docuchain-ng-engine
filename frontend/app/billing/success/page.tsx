          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Your DocuChain subscription is now active. Let&apos;s select your workspace role to finalize setup.
              </p>
              {reference && (
                <div className="pt-2">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-left space-y-2 text-xs">
              ...
              <p className="text-slate-400 text-[11px]">
                Statutory notice alerts and cross-vault indexing are now active.
              </p>
            </div>
